...
<dialog id="saved-dialog" aria-labelledby="saved-title"><div class="dialog-heading"><h2 id="saved-title">Saved cars</h2><button type="button" data-close-dialog aria-label="Close saved cars"><span class="icon icon-x" aria-hidden="true"></span>Close</button></div><div data-saved-list><h3>No saved cars yet</h3><p>Keep a shortlist on this device.</p><a href="latest-cars.html?view=all">Explore cars</a></div><div data-saved-undo hidden><p></p><button type="button" data-undo-saved>Undo</button></div><div data-saved-comparison-undo hidden><p>Car removed from comparison.</p><button type="button" data-undo-selection data-undo-compare>Undo comparison removal</button></div><p data-saved-status role="status" aria-live="polite"></p></dialog>
