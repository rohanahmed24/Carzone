...
${['tokens','base','shell','home','compare','forms',...({inventory:['inventory'],vehicle:['vehicle']}[page.controller] ?? [])].map(name=>`<link rel="stylesheet" href="/assets/styles/${name}.css">`).join('\n')}
...
<p class="container storage-warning" data-storage-warning role="status" hidden></p>
<div class="selection-undo" data-page-saved-undo hidden><p></p><button type="button" data-undo-saved>Undo saved car removal</button></div>
<main id="main">${page.body}</main>
<footer class="site-footer"><div class="container footer-inner"><div>${brand()}<p>Demo portfolio. Vehicles, prices and specifications are illustrative. Nothing is sold or submitted here.</p></div><nav aria-label="Footer navigation">${navLinks()}<a href="car-valuation.html">About car valuation</a><a href="style-guide.html">Style guide</a></nav></div></footer>
...
<dialog id="saved-dialog" aria-labelledby="saved-title"><div class="dialog-heading"><h2 id="saved-title">Saved cars</h2><button type="button" data-close-dialog aria-label="Close saved cars"><span class="icon icon-x" aria-hidden="true"></span>Close</button></div><p data-storage-warning role="status" hidden></p><div data-saved-list><h3>No saved cars yet</h3><p>Keep a shortlist on this device.</p><a href="latest-cars.html?view=all">Explore cars</a></div><div data-saved-undo hidden><p></p><button type="button" data-undo-saved>Undo saved car removal</button></div><div data-saved-comparison-undo hidden><p>Car removed from comparison.</p><button type="button" data-undo-selection data-undo-compare>Undo comparison removal</button></div><p data-saved-status role="status" aria-live="polite"></p></dialog>
<dialog id="enquiry-dialog" class="enquiry-dialog" aria-labelledby="enquiry-title"></dialog>
...
<div class="selection-undo" data-selection-undo hidden><p></p><button type="button" data-undo-selection>Undo</button></div>
